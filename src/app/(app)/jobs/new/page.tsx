...
export default function NewJobPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Add Job Lead" subtitle="Capture a role manually or ingest a posting, review the extracted fields, then save it into your workspace." />
      ...
      {ingestionResult ? (
        <div className="card-pad">
          ...
          <p className="mt-3 text-sm leading-7 text-muted">
            Parser mode: {ingestionResult.sourceMode}. Review and edit the prefilled fields below before saving. This keeps the
            user in control while still reducing job-entry friction.
          </p>
        </div>
      ) : null}
      <JobForm mode="create" onSubmit={handleCreate} initialValues={prefillValues} resetToken={resetToken} />
    </div>
  );
}
